...
function show_posts() {
    ...
    if (w != null) {
        document.querySelector("#ps-eb").classList.remove("show_status");
        w.innerHTML = `
    ...
    x.innerHTML = `
    <i class="fs-5 bi bi-file-richtext-fill mx-2"></i><span class="d-none d-sm-block mx-2" style="font-size: 0.9rem">Posts</span>
    `;
    z.innerHTML = `
...
function show_saved_posts() {
    ...
    if (y !== null) {
        ...
        y.innerHTML = `
        <i class="fs-5 bi bi-bookmark-fill mx-2"></i><span class="d-none d-sm-block mx-2" style="font-size: 0.9rem">Saved</span>
        `;
    }
    if (w != null) {
        document.querySelector("#ps-eb").classList.remove("show_status");
...
function show_info() {
    ...
    `;
    z.innerHTML = `
    <i class="fs-5 bi bi-info-square-fill "></i><span class="d-none d-sm-block mx-2" style="font-size: 0.9rem">Info</span>
    `;
}

function show_events() {
    document.querySelector("#profile-posts-d").style.display = "none";
    document.querySelector("#profile-events-d").style.display = "flex";
    document.querySelector("#profile-saved-posts-d").style.display = "none";
    document.querySelector("#profile-info-d").style.display = "none";
    ...
    if (w != null) {
        document.querySelector("#ps-eb").classList.add("show_status");
        w.innerHTML = `
        <i class="fs-5 bi bi-calendar-event-fill mx-2"></i><span class="d-none d-sm-block mx-2" style="font-size: 0.9rem">Events</span>
        `;
    }
    document.querySelector("#ps-pb").classList.remove("show_status");
    document.querySelector("#ps-ib").classList.remove("show_status");
